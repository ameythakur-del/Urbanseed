...
public class ImageRecyclerAdapter extends RecyclerView.Adapter<ImageRecyclerAdapter.ViewHolder> {
    ...
    public ImageRecyclerAdapter(Context context, List<Tag> imageList) {
    ...
    public ImageRecyclerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new ImageRecyclerAdapter.ViewHolder(view, context);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference().child("Snacks");
