...
public class ImageRecyclerAdapter3 extends RecyclerView.Adapter<ImageRecyclerAdapter3.ViewHolder> {
    private Context context;
    private List<Tag> imageList;

    public ImageRecyclerAdapter3(Context context, List<Tag> imageList) {
        this.context = context;
        this.imageList = imageList;
    }
    @NonNull
    @Override
    public ImageRecyclerAdapter3.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context)
                .inflate(R.layout.image, viewGroup, false);
        return new ImageRecyclerAdapter3.ViewHolder(view, context);
    }

    @Override
    public void onBindViewHolder(@NonNull ImageRecyclerAdapter3.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference().child("padartha");
