...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_gallery, R.id.order_history, R.id.nav_money, R.id.nav_cart, R.id.nav_wishlist, R.id.nav_about_us, R.id.contact_us)
    ...
    protected void onResume() {
        ...
        navigationView.getMenu().findItem(R.id.order_history).setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                if(FirebaseAuth.getInstance().getCurrentUser() != null) {
                    startActivity(new Intent(Main2Activity.this, OrderHistory.class));
                    drawer.closeDrawers();
                }
                else{
                    finish();
